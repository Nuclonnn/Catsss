...
namespace Catsss.EditorTools
{
    ...
    public static class LocalizationSetupMenu
    {
        ...
        private static readonly (string Key, string English, string Russian)[] DefaultEntries =
        {
            ...
            ("menu.button.settings", "Settings", "Настройки"),
            ("menu.button.back", "Back", "Назад"),
            ("menu.button.quit", "Quit", "Выйти"),
            ("settings.title", "Settings", "Настройки"),
            ("settings.sensitivity", "Mouse sensitivity", "Чувствительность мыши"),
            ("settings.language", "Language", "Язык"),
            ("settings.language.english", "English", "English"),
            ("settings.language.russian", "Russian", "Русский"),
            ("menu.banner.host_disconnected", "Host disconnected.", "Хост отключился."),
            ("menu.banner.session_ended", "Session ended.", "Сессия завершена."),
            ("menu.level_select.title", "Levels", "Уровни"),
            ("menu.level_select.play", "Play", "Играть"),
            ("menu.level_select.locked", "Locked", "Заблокировано"),
            ("level.sandbox.name", "Sandbox", "Песочница"),
            ("level.level02.name", "Level 2", "Уровень 2"),
            ...
            ("menu.error.scene_load_failed", "Could not load level \"{0}\". Add it to Build Profiles and check the scene name in Level Catalog.", "Не удалось загрузить уровень «{0}». Добавьте сцену в Build Profiles и проверьте имя в Level Catalog."),
