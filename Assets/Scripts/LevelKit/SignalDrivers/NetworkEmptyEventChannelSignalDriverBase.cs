...
{
    /// <summary>NetworkBehaviour-версия базового signal driver (зоны с ClientRpc sync).</summary>
    public abstract class NetworkEmptyEventChannelSignalDriverBase : NetworkBehaviour
    {
        [Header("Channels")]
