...
{
    /// <summary>
    /// Полупрозрачная заглушка потока воздуха. Логика зоны не зависит от визуала; позже заменить на particles/mesh.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class AeroZoneVisualStub : MonoBehaviour
    {
        [SerializeField] private AeroZone zone;
        [SerializeField] private Renderer[] renderers;
        [SerializeField] private string colorPropertyName = "_BaseColor";
        [SerializeField] private Color baseColor = new(0.35f, 0.85f, 1f, 0.28f);
        ...
        private void ResolveReferences()
        {
            if (zone == null)
            {
                zone = GetComponentInParent<AeroZone>();
            }
