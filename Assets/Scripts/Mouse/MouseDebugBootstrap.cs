...
{
    /// <summary>
    /// Отладочные сценарии мыши (только Editor / dev-сборки). Не использовать на финальной сцене.
    /// Вешать на сцену рядом с MouseBrain; компонент можно отключить или удалить перед релизом.
    /// </summary>
